...
df = pd.read_excel('C:/Users/Jacob Steenhuysen/Downloads/Prospective New Tickers.xlsx', sheet_name='Sheet1')
...
ecommerce_income_statement_data = yahoo_financials_ecommerce.get_financial_stmts('annual', 'cash')

data = ecommerce_income_statement_data['cashflowStatementHistory']
...
export_excel = df.to_excel(r'C:/Users/Jacob Steenhuysen/Downloads/Cashflow Statment Histories.xlsx', sheet_name="Sheet1", index= True)
